    ...
    <div class="container">
        <form method="post" action="<?php echo site_url('CrudController/update')?>/<?php echo $row->id; ?>">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" value="<?php echo $row->birthdate; ?>" name="birthdate"  placeholder="Enter birthdate">
            </div>
            <div class="form-group">
                <label >Contact</label>
                <input type="text" class="form-control" value="<?php echo $row->contactNo; ?>" name="contactNo"  placeholder="Enter contact">
            </div>
